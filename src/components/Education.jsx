  ...
  const educationData = [
    {
      ...
      year: "2022 - 2026",
      score: "CGPA: 7.60/10.0",
      description: "Specialization in Full stack web Development with honors thesis on visual recognition systems.",
      image: "/university-logo.png" // Replace with actual image path
    },
    {
      ...
      image: "/highschool-logo.png" // Replace with actual image path
    },
    {
      ...
      year: "2019 - 2020",
      score: "91%",
      description: "Recipient of the academic excellence award for consistent performance across all subjects.",
      image: "/middleschool-logo.png" // Replace with actual image path
    }
  ];
