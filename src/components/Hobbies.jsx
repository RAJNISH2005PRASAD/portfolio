  ...
  const hobbiesData = [
    {
      title: "Photography",
      icon: "📷",
      description: "I enjoy capturing moments through my lens, particularly focusing on street photography and landscapes. Photography helps me observe details and find beauty in everyday scenes.",
      bgColor: "bg-gradient-to-br from-purple-600 to-blue-500",
      images: [
        "/photography-1.jpg", // Replace with actual image paths
        "/photography-2.jpg",
        "/photography-3.jpg",
        "/photography-4.jpg"
      ]
    },
    {
      title: "Chess",
      icon: "♟️",
      description: "Strategic thinking and patience are skills I hone through chess. I enjoy both casual games and solving complex puzzles, which has improved my problem-solving abilities in other areas of life.",
      bgColor: "bg-gradient-to-br from-emerald-600 to-teal-500",
      images: [
        "/chess-1.jpg", // Replace with actual image paths
        "/chess-2.jpg",
        "/chess-3.jpg",
        "/chess-4.jpg"
      ]
