...
const CVSection = () => {
  return (
    <motion.div variants={fadeIn("left", "spring", 0.5, 0.75)}>
      <div className="w-full p-5 bg-tertiary rounded-2xl">
        ...
        <div className="flex justify-end mt-4">
          <button 
            onClick={() => window.open("https://github.com/RAJNISH2005PRASAD/cv/blob/main/specilaized%20cv.pdf", "_blank")} 
      ...
      <div className="w-full p-5 bg-tertiary rounded-2xl">
        ...
        <div className="w-full h-[300px] bg-black/50 rounded-2xl flex items-center justify-center relative overflow-hidden">
          ...
          <div className="absolute inset-0 flex items-center justify-center text-xl text-white">
            <p>Video CV Preview</p>
          </div>
          
          {/* Uncomment when you have the actual video */}
          <video 
...
const Portfolio = () => {
  return (
    <>
      ...
      <div className="grid grid-cols-1 mt-20 lg:grid-cols-2 gap-7">
        <CVSection />
        <VideoCV />
      </div>
    </>
