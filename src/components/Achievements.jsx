  ...
  const achievements = [
    {
      ...
      description: "First place at the International Dev Hackathon for creating an innovative solution that addresses accessibility issues in web applications.",
      date: "March 2024",
      icon: icons[0]
    },
    {
      title: "Open Source Contributor",
      description: "Contributed to multiple high-profile open source projects with over 20 accepted pull requests improving performance and adding new features.",
      date: "2022 - Present",
      icon: icons[1]
    },
    {
      title: "Certification Excellence",
      description: "Achieved top scores in advanced certifications for full-stack development, cloud architecture, and machine learning fundamentals.",
      date: "December 2023",
      icon: icons[2]
    },
    {
      title: "Conference Speaker",
      description: "Delivered technical presentations at three major developer conferences on WebGL, React performance optimization, and 3D web technologies.",
      date: "2023 - 2024",
      icon: icons[3]
    },
    {
      title: "Feature Project",
      description: "Personal project was featured on Product Hunt reaching #3 Product of the Day and gaining over 5,000 users within the first week of launch.",
      date: "July 2023",
      icon: icons[4]
    },
    {
      title: "Technical Publication",
      description: "Published technical article series on advanced web animation techniques that has garnered over 50,000 views and was featured in industry newsletters.",
      date: "January 2024",
      icon: icons[5]
    }
  ];
